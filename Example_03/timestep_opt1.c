...
/*
 * Version with a simple OpenMP SIMD pragma and reduction.
 * The pragma instructs the compiler to vectorize the loop and
 * perform the min-reduction across SIMD lanes.
 */
