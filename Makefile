# ======================================================
# IT2004 - Parallel Programming
# Example 3 - AoSoA Measurement Benchmark
# Author: Adnan Hajro
# ======================================================
...
all:
	...
	@echo "Available vector sizes: $(VECTOR_LENGTHS)"
...
# ======================================================
# Template definition for test generation
# Each test runs multiple vector widths and saves results to CSV
# ======================================================
define MAKE_TEST
test_$(1):
	@echo "============================================="
...
# ======================================================
# Generate test targets automatically for all lengths
# ======================================================
$(foreach N,$(LENGTHS),$(eval $(call MAKE_TEST,$(N))))

# Aliases for human-friendly short test names
test_1K: test_1000
test_10K: test_10000
